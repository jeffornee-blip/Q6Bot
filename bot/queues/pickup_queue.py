	...
	cfg_factory = CfgFactory(
		...
		variables=[
			...
			Variables.OptionVar(
				...
				section="Teams",
				options=["by role and rating", "fair pairs", "random with role preference", "random", "smart", "no captains"],
				...
				description="\n".join([
					...
					"  smart - prioritize captain role, similar MMR, shared Quidditch position, avoid recent captains",
